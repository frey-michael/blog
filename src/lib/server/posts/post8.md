...
summary: 'When discussing details of managed data products, it can be helpful to have a clear picture of reference implementation. Since we currently work predominantly with Microsoft Fabric, this blog post provides a comprehensive overview of the platform features we use to create data products.'
---
...
You can find the example data product discussed in this blog post [here](https://github.com/frey-michael/blog-dpInFabric-employeeVacation).
...
:-------------------------:|:-------------------------:
![Artefacts in Fabric](/img/post8/dp_overview_fabric.png) | ![Artefacts in Repository](/img/post8/dp_overview_git.png)
...
![Resource Synch Setting in Notebook](/img/post8/resource_setting_fabric.png)
...
:-------------------------:|:-------------------------:
![Contract File in Fabric](/img/post8/dp_file_fabric.png) | ![Contract File in Repository](/img/post8/dp_file_git.png)
